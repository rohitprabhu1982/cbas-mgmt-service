...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>cell-history-dialog works!</p>\r\n<ag-grid-angular style=\"width: 100%; height: 200px;\" class=\"ag-theme-balham\"\r\n    [rowData]=\"rowData\" [columnDefs]=\"columnDefs\">\r\n</ag-grid-angular>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiEndpointsConfig", function() { return ApiEndpointsConfig; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let ApiEndpointsConfig = class ApiEndpointsConfig {
    constructor() { }
    get getBaseUrl() {
...
ApiEndpointsConfig = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let AppConfigService = class AppConfigService {
    ...
    load() {
        const env = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].envName ? _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].envName : 'production';
        this._env = env;
        ...
        // .map(res => res.json())
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(configData => {
    ...
    getConfig() {
        if (this.config === null) {
            return this.load().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(config => {
...
/* harmony import */ var _shared_services_login_in_user_guard_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/services/login-in-user-guard.service */ "./src/app/shared/services/login-in-user-guard.service.ts");
/* harmony import */ var _components_error_page_error_page_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/error-page/error-page.component */ "./src/app/components/error-page/error-page.component.ts");
/* harmony import */ var _components_current_req_reports_current_req_reports_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/current-req-reports/current-req-reports.component */ "./src/app/components/current-req-reports/current-req-reports.component.ts");
/* harmony import */ var _components_acquisitions_fy_twenty_acquisitions_fy_twenty_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/acquisitions-fy-twenty/acquisitions-fy-twenty.component */ "./src/app/components/acquisitions-fy-twenty/acquisitions-fy-twenty.component.ts");
/* harmony import */ var _components_submit_plan_submit_plan_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/submit-plan/submit-plan.component */ "./src/app/components/submit-plan/submit-plan.component.ts");
/* harmony import */ var _components_apprve_spnd_plan_apprve_spnd_plan_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/apprve-spnd-plan/apprve-spnd-plan.component */ "./src/app/components/apprve-spnd-plan/apprve-spnd-plan.component.ts");
...
const routes = [
    ...
    {
        path: 'reports/current-req-report', component: _components_current_req_reports_current_req_reports_component__WEBPACK_IMPORTED_MODULE_7__["CurrentReqReportsComponent"],
        canActivate: [_shared_services_login_in_user_guard_service__WEBPACK_IMPORTED_MODULE_5__["LoggedInUserGuard"]],
        data: {
            page_header: 'Dashboard'
        }
    ...
    {
        path: 'submit-plan', component: _components_submit_plan_submit_plan_component__WEBPACK_IMPORTED_MODULE_9__["SubmitPlanComponent"]
    },
    {
        path: 'approvePlan/approve-submit-plan', component: _components_apprve_spnd_plan_apprve_spnd_plan_component__WEBPACK_IMPORTED_MODULE_10__["ApprveSpndPlanComponent"]
    },
    {
        path: 'acquistions-fy20', component: _components_acquisitions_fy_twenty_acquisitions_fy_twenty_component__WEBPACK_IMPORTED_MODULE_8__["AcquisitionsFyTwentyComponent"],
        canActivate: [_shared_services_login_in_user_guard_service__WEBPACK_IMPORTED_MODULE_5__["LoggedInUserGuard"]],
        data: {
    ...
    {
        path: 'login', component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], data: {
            page_header: 'Login'
        }
    },
    {
...
/* harmony import */ var _shared_services_user_logged_in_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/services/user-logged-in.service */ "./src/app/shared/services/user-logged-in.service.ts");
...
let AppComponent = class AppComponent {
    constructor(idle, keepalive, authService, router, modalService, userLoggedInService) {
        this.idle = idle;
        ...
        ag_grid_enterprise__WEBPACK_IMPORTED_MODULE_8__["LicenseManager"].setLicenseKey('[TRIAL]_10_August_2019_[v2]_MTU2NTM5NTIwMDAwMA==53f1292ef78d2de19c8266ac2435ead81234');
        // this.reset();
    }
    reset() {
        this.idle.watch();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyBrowserXhr", function() { return MyBrowserXhr; });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _app_config_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app-config.service */ "./src/app/app-config.service.ts");
...
//   }
// }
let MyBrowserXhr = class MyBrowserXhr {
    constructor() { }
    build() { return (new XMLHttpRequest()); }
};
MyBrowserXhr = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Injectable"])()
], MyBrowserXhr);
...
let AppConfig = class AppConfig {
    ...
    load() {
        ...
        const injector = _angular_core__WEBPACK_IMPORTED_MODULE_3__["Injector"].create([
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["XhrFactory"], useClass: MyBrowserXhr, deps: [] },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHandler"], useClass: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpXhrBackend"], deps: [_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["XhrFactory"]] },
            ...
            { provide: _app_config_service__WEBPACK_IMPORTED_MODULE_5__["AppConfigService"], useClass: _app_config_service__WEBPACK_IMPORTED_MODULE_5__["AppConfigService"], deps: [_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]] }
        ]);
        ...
        //   AppConfigService
        // ]);
        const configService = injector.get(_app_config_service__WEBPACK_IMPORTED_MODULE_5__["AppConfigService"]);
        // const configService = new AppConfigService(new HttpClient(new HttpXhrBackend(new BrowserXhr())));
        return configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(config => {
...
/* harmony import */ var _shared_services_login_in_user_guard_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shared/services/login-in-user-guard.service */ "./src/app/shared/services/login-in-user-guard.service.ts");
...
/* harmony import */ var _components_error_page_error_page_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/error-page/error-page.component */ "./src/app/components/error-page/error-page.component.ts");
/* harmony import */ var _shared_components_page_header_page_header_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./shared/components/page-header/page-header.component */ "./src/app/shared/components/page-header/page-header.component.ts");
...
/* harmony import */ var _shared_services_user_logged_in_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./shared/services/user-logged-in.service */ "./src/app/shared/services/user-logged-in.service.ts");
/* harmony import */ var _ng_idle_keepalive__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @ng-idle/keepalive */ "./node_modules/@ng-idle/keepalive/fesm2015/ng-idle-keepalive.js");
/* harmony import */ var _app_config_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./app-config.service */ "./src/app/app-config.service.ts");
/* harmony import */ var _app_config__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./app.config */ "./src/app/app.config.ts");
/* harmony import */ var _app_api_endpoints_config__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./app-api-endpoints.config */ "./src/app/app-api-endpoints.config.ts");
/* harmony import */ var ng_busy__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ng-busy */ "./node_modules/ng-busy/fesm2015/ng-busy.js");
...
/* harmony import */ var _shared_services_admin_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./shared/services/admin.service */ "./src/app/shared/services/admin.service.ts");
/* harmony import */ var _shared_interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./shared/interceptors/jwt.interceptor */ "./src/app/shared/interceptors/jwt.interceptor.ts");
/* harmony import */ var _shared_interceptors_error_interceptor__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./shared/interceptors/error.interceptor */ "./src/app/shared/interceptors/error.interceptor.ts");
/* harmony import */ var ag_grid_angular__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ag-grid-angular */ "./node_modules/ag-grid-angular/main.js");
/* harmony import */ var ag_grid_angular__WEBPACK_IMPORTED_MODULE_27___default = /*#__PURE__*/__webpack_require__.n(ag_grid_angular__WEBPACK_IMPORTED_MODULE_27__);
/* harmony import */ var _components_current_req_reports_current_req_reports_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/current-req-reports/current-req-reports.component */ "./src/app/components/current-req-reports/current-req-reports.component.ts");
/* harmony import */ var _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./shared/services/acquisition.service */ "./src/app/shared/services/acquisition.service.ts");
/* harmony import */ var _shared_services_smartListConversion_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./shared/services/smartListConversion.service */ "./src/app/shared/services/smartListConversion.service.ts");
/* harmony import */ var _components_acquisitions_fy_twenty_acquisitions_fy_twenty_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/acquisitions-fy-twenty/acquisitions-fy-twenty.component */ "./src/app/components/acquisitions-fy-twenty/acquisitions-fy-twenty.component.ts");
/* harmony import */ var ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ngx-bootstrap/tabs */ "./node_modules/ngx-bootstrap/tabs/fesm2015/ngx-bootstrap-tabs.js");
/* harmony import */ var _components_apprve_spnd_plan_apprve_spnd_plan_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/apprve-spnd-plan/apprve-spnd-plan.component */ "./src/app/components/apprve-spnd-plan/apprve-spnd-plan.component.ts");
/* harmony import */ var _components_submit_plan_submit_plan_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/submit-plan/submit-plan.component */ "./src/app/components/submit-plan/submit-plan.component.ts");
/* harmony import */ var _shared_components_footer_footer_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./shared/components/footer/footer.component */ "./src/app/shared/components/footer/footer.component.ts");
/* harmony import */ var _shared_components_new_header_new_header_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./shared/components/new-header/new-header.component */ "./src/app/shared/components/new-header/new-header.component.ts");
...
/* harmony import */ var _shared_components_dropdown_dropdown_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./shared/components/dropdown/dropdown.component */ "./src/app/shared/components/dropdown/dropdown.component.ts");
/* harmony import */ var _shared_components_text_input_text_input_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./shared/components/text-input/text-input.component */ "./src/app/shared/components/text-input/text-input.component.ts");
/* harmony import */ var _shared_components_validation_msg_validation_msg_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./shared/components/validation-msg/validation-msg.component */ "./src/app/shared/components/validation-msg/validation-msg.component.ts");
/* harmony import */ var _shared_components_dropdown_search_filter_pipe__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./shared/components/dropdown/search-filter.pipe */ "./src/app/shared/components/dropdown/search-filter.pipe.ts");
/* harmony import */ var angular_gridster2__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! angular-gridster2 */ "./node_modules/angular-gridster2/fesm2015/angular-gridster2.js");
/* harmony import */ var _shared_services_layout_service__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./shared/services/layout.service */ "./src/app/shared/services/layout.service.ts");
/* harmony import */ var _shared_directives_layout_item_directive__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./shared/directives/layout-item.directive */ "./src/app/shared/directives/layout-item.directive.ts");
/* harmony import */ var _shared_components_cell_history_dialog_cell_history_dialog_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./shared/components/cell-history-dialog/cell-history-dialog.component */ "./src/app/shared/components/cell-history-dialog/cell-history-dialog.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _shared_components_page_header_page_header_component__WEBPACK_IMPORTED_MODULE_15__["PageHeaderComponent"],
            _components_current_req_reports_current_req_reports_component__WEBPACK_IMPORTED_MODULE_28__["CurrentReqReportsComponent"],
            _components_acquisitions_fy_twenty_acquisitions_fy_twenty_component__WEBPACK_IMPORTED_MODULE_31__["AcquisitionsFyTwentyComponent"],
            _components_apprve_spnd_plan_apprve_spnd_plan_component__WEBPACK_IMPORTED_MODULE_33__["ApprveSpndPlanComponent"],
            _components_submit_plan_submit_plan_component__WEBPACK_IMPORTED_MODULE_34__["SubmitPlanComponent"],
            _shared_components_footer_footer_component__WEBPACK_IMPORTED_MODULE_35__["FooterComponent"],
            _shared_components_new_header_new_header_component__WEBPACK_IMPORTED_MODULE_36__["NewHeaderComponent"],
            _shared_directives_layout_item_directive__WEBPACK_IMPORTED_MODULE_44__["LayoutItemDirective"],
            _shared_components_dropdown_dropdown_component__WEBPACK_IMPORTED_MODULE_38__["CBASSelectComponent"],
            _shared_components_dropdown_dropdown_component__WEBPACK_IMPORTED_MODULE_38__["CBASMultiSelectComponent"],
            _shared_components_text_input_text_input_component__WEBPACK_IMPORTED_MODULE_39__["TextInputComponent"],
            _shared_components_validation_msg_validation_msg_component__WEBPACK_IMPORTED_MODULE_40__["ValidationMsg"],
            _shared_components_dropdown_search_filter_pipe__WEBPACK_IMPORTED_MODULE_41__["MultiSelectSearchFilter"],
        ...
        imports: [
            ...
            ng_busy__WEBPACK_IMPORTED_MODULE_22__["NgBusyModule"],
            angular_gridster2__WEBPACK_IMPORTED_MODULE_42__["GridsterModule"],
            _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_23__["BrowserAnimationsModule"],
            ag_grid_angular__WEBPACK_IMPORTED_MODULE_27__["AgGridModule"].withComponents([]),
            ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_32__["TabsModule"].forRoot() // Jas
        ],
        providers: [
            _shared_services_login_in_user_guard_service__WEBPACK_IMPORTED_MODULE_9__["LoggedInUserGuard"], _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"], _shared_services_user_logged_in_service__WEBPACK_IMPORTED_MODULE_17__["UserLoggedInService"], _app_config_service__WEBPACK_IMPORTED_MODULE_19__["AppConfigService"], _app_config__WEBPACK_IMPORTED_MODULE_20__["AppConfig"], _app_api_endpoints_config__WEBPACK_IMPORTED_MODULE_21__["ApiEndpointsConfig"], _shared_services_admin_service__WEBPACK_IMPORTED_MODULE_24__["AdminService"], _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_29__["AcquisitionService"],
            _shared_services_smartListConversion_service__WEBPACK_IMPORTED_MODULE_30__["SmartListConversionService"], _shared_services_layout_service__WEBPACK_IMPORTED_MODULE_43__["LayoutService"],
            {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AcquisitionsFyTwentyComponent", function() { return AcquisitionsFyTwentyComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/auth.service */ "./src/app/shared/services/auth.service.ts");
/* harmony import */ var _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/services/acquisition.service */ "./src/app/shared/services/acquisition.service.ts");
/*tslint:disable:no-inferrable-types*/
...
let AcquisitionsFyTwentyComponent = class AcquisitionsFyTwentyComponent {
    constructor(fb, authService, acquisitionService) {
        this.fb = fb;
        this.authService = authService;
    ...
    // jaswanthi
    acquisitionDropDown() {
        this.acquisitionService.getAcquisitionPreCommitmentData().subscribe(args => {
            if (args !== null) {
                this.officeLists = args.officeList;
                this.acquisitionTypesList = args.acquisitionTypeList;
                this.versionLists = args.versionList;
                this.projectTitleLists = args.projectTitleList;
            }
        });
    }
    onOfficeChangeEvent(event) {
        ...
        this.acquisitionService.getAcquisitionPreCommitmentDataWithOffice(this.officeName.slice(3)).subscribe(args => {
            if (args !== null) {
                this.acquisitionTypesList = args.acquisitionTypeList;
                this.versionLists = args.versionList;
                this.projectTitleLists = args.projectTitleList;
    ...
    onPtitleChangeEvent(event) {
        this.ptitle = event.target.value;
    }
    onVersionChangeEvent(event) {
        this.version = event.target.value;
    }
    onAcquisitionTypeChangeEvent(event) {
        this.acquisitionType = event.target.value;
        this.ChangeForm.controls.version.setValue(null);
        this.acquisitionService.getAcquisitionPreCommitmentDataWithAcquisition(this.officeName.slice(3), this.acquisitionType.slice(3)).subscribe(args => {
            if (args !== null) {
                this.acquisitionTypesList = args.acquisitionTypeList;
                this.versionLists = args.versionList;
                this.projectTitleLists = args.projectTitleList;
    ...
    saveAcquisition() {
        const a = this.postComittmentForm.value;
        if (this.postComittmentForm.value) {
            ...
            this.busyTableSave = this.acquisitionService
                .postAcquisitionData(this.commitmentData, this.officeName.slice(3), this.acquisitionType.slice(3), this.version.slice(3))
                .subscribe(args => {
    ...
    getAcquisitionFYTwenty() {
        this.acquisitionService
            .getAcquisitionFYTwentyData(this.officeName.slice(3), this.acquisitionType.slice(3), this.version.slice(3), this.ptitle.slice(3))
            .subscribe(a => {
            if (a != null) {
                this.projectheader = this.ptitle.slice(3);
                console.log(this.acquisitionModel, 'parserrrrrrr');
                ...
                this.acquisitionModel = a[0];
                // this.postComittmentForm.controls.projectTitle.setValue(this.acquisitionModel.projectTitle);
                // this.postComittmentForm
                this.postComittmentForm.setValue(this.acquisitionModel);
            }
        });
    }
};
AcquisitionsFyTwentyComponent.ctorParameters = () => [
...
AcquisitionsFyTwentyComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-acquisitions-fy-twenty',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./acquisitions-fy-twenty.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/acquisitions-fy-twenty/acquisitions-fy-twenty.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./acquisitions-fy-twenty.component.scss */ "./src/app/components/acquisitions-fy-twenty/acquisitions-fy-twenty.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApprveSpndPlanComponent", function() { return ApprveSpndPlanComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/auth.service */ "./src/app/shared/services/auth.service.ts");
/* harmony import */ var _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/services/acquisition.service */ "./src/app/shared/services/acquisition.service.ts");
/* harmony import */ var src_app_shared_services_smartListConversion_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/services/smartListConversion.service */ "./src/app/shared/services/smartListConversion.service.ts");
/* harmony import */ var ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-bootstrap/modal */ "./node_modules/ngx-bootstrap/modal/fesm2015/ngx-bootstrap-modal.js");
...
let ApprveSpndPlanComponent = class ApprveSpndPlanComponent {
    constructor(fb, authService, acquisitionService, smartListService, modalService) {
        this.fb = fb;
        this.authService = authService;
        this.acquisitionService = acquisitionService;
    ...
    ngOnInit() {
        ...
        this.roleList = this.authService.jwt_getRole();
        this.acquisitionService.getAcquisitionOfficeData().subscribe(args => {
            this.officeList = args;
    ...
    openSubmitDialog() {
        ...
        this.bsModalRef = this.modalService.show(src_app_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmDialogComponent"], { initialState });
    ...
    acquisition() {
        this.busyTableSave = this.acquisitionService
            .getAcquisitionCTPDataWithOptional(this.officeCtp, this.roleList)
            .subscribe(args => {
            ...
            if ((args != null) && (args.length > 0)) {
                ...
                this.smartListService.getSmartList(this.acquisitionData);
                this.autoSizeCols(false);
            }
            else {
                this.acquisitionData = [];
            }
    ...
    bracketsFormatter(params) {
        const i = Math.floor(params.value).toString();
        if (i !== null && i[0] === '-') {
    ...
    getColDefs() {
        this.colDefs = [
            ...
            // },
            {
                ...
                cellEditorParams: {
                    values: ['IDIQ - Competitive', 'BPA - Competitive',
                        'Stand Alone Contract - Competitive',
                        'IDIQ - Non Competitive', 'BPA - Non Competitive',
                        'Stand Alone Contract - Non Competitive',
                        'TO/DO - Competitive', 'TO/DO - Non Competitive',
                        '8(a) Contracts - Non Competitive', 'GSA/GWAC Services, NO SOW',
                        'GSA/GWAC for Services Requiring a SOW',
                        'Simplified Acquisition ($25001 - $250000)',
                        'Option Exercise', 'Bilateral Contract Modification',
                        'HHS Strategic Sourcing BPA TO/DO - Non Competitive',
                        'Basic Ordering Agreement',
                        'Broad Agency Announcement',
                        'Simplified Acquisition ($10001 to $25000)',
                        'Simplified Acquisition Micropurchase <=10000',
            ...
            },
            {
                ...
                sortable: true,
                cellRenderer: (data) => {
                    return data.value ? (new Date(data.value)).toLocaleDateString('en-US', { timeZone: 'UTC' }) : '';
                },
                suppressSizeToFit: true,
            ...
            },
            {
                ...
                cellStyle: (params) => {
                    if (params.value !== null) {
                        return params.value[0] === '-' ? { color: 'red', 'text-align': 'right' } : { color: 'black', 'text-align': 'right' };
                    }
                    else {
...
ApprveSpndPlanComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_4__["AcquisitionService"] },
...
ApprveSpndPlanComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-apprve-spnd-plan',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./apprve-spnd-plan.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/apprve-spnd-plan/apprve-spnd-plan.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./apprve-spnd-plan.component.scss */ "./src/app/components/apprve-spnd-plan/apprve-spnd-plan.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CurrentReqReportsComponent", function() { return CurrentReqReportsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/auth.service */ "./src/app/shared/services/auth.service.ts");
/* harmony import */ var _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/services/acquisition.service */ "./src/app/shared/services/acquisition.service.ts");
/* harmony import */ var src_app_shared_models_dropdown_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/models/dropdown.model */ "./src/app/shared/models/dropdown.model.ts");
/* harmony import */ var src_app_shared_services_smartListConversion_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/smartListConversion.service */ "./src/app/shared/services/smartListConversion.service.ts");
/* harmony import */ var src_app_shared_services_grid_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/services/grid.service */ "./src/app/shared/services/grid.service.ts");
...
/* harmony import */ var src_app_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/components/confirm-dialog/confirm-dialog.component */ "./src/app/shared/components/confirm-dialog/confirm-dialog.component.ts");
...
let CurrentReqReportsComponent = class CurrentReqReportsComponent {
    constructor(fb, authService, acquisitionService, smartListService, gridService, modalService) {
        this.fb = fb;
        this.authService = authService;
        this.acquisitionService = acquisitionService;
        this.smartListService = smartListService;
        ...
        this.gridOptions = {
            ...
            onCellValueChanged: params => {
                if (params.oldValue !== params.newValue) {
                    const changedData = params.data;
                    // params.api.updateRowData({ update: changedData });
                    this.editedData.push(changedData);
                    console.log(this.editedData);
                }
            },
            stopEditingWhenGridLosesFocus: true,
    ...
    filterData() {
        ...
        this.busyTableSave = this.acquisitionService.getAcquisitionGridFilter(userId).subscribe(args => {
            if (args) {
                args.forEach(el => {
                    el.filterJson = JSON.parse(el.filterJson);
                });
                this.filterJson = args;
                // this.filterJson = args.map(m => ({id: m.userFilterId, name: m.filterName, filterJson: m.filterJson}));
                console.log(this.filterJson);
            }
        });
    }
    ondateRangeEndingChanged(e) {
        console.log('e', e);
    }
    acquisitionDropDown() {
        this.acquisitionService.getAcquisitionPreCommitmentData().subscribe(args => {
            this.acquisitionDropDownData = args;
            console.log(this.acquisitionDropDownData.officeList, 'AAAAAA');
        });
    }
    onOfficeChangeEvent(event) {
        this.officeName = event.target.value;
    ...
    onFilterChangeEvent(event) {
        ...
        let groupModel = null;
        this.filterJson.forEach(element => {
            if (event === element.filterName) {
                ...
                // this.gridColumnApi.setGroupState(element.groupState);
            }
        });
    ...
    acquisition() {
        ...
        this.busyTableSave = this.acquisitionService
            .getAcquisitionCTPData(this.officeName.slice(3), this.acquisitionType.slice(3), this.version.slice(3), this.roleList)
            .subscribe(args => {
            this.isDataPresent = true;
            if ((args !== null) && (args.length > 0)) {
                this.getColDefs();
    ...
    postAcquisition() {
        if (this.editedData.length > 0) {
            ...
            this.busyTableSave = this.acquisitionService
                .postAcquisitionData(this.editedData, this.officeName.slice(3), this.acquisitionType.slice(3), this.version.slice(3))
                .subscribe(args => {
                this.editedData = [];
                if (args !== null) {
                    console.log('post args', args);
    ...
    currencyFormatter(params) {
        const i = this.formatNumber(params.value);
        return i !== '' ? ('\x24' + i) : '';
    }
    formatNumber(params) {
        // (number.value !== null && number.value !== undefined) ? Math.floor(number.value) : ''
        return (params !== null && params !== undefined) ? Math.floor(params)
            .toString()
            .replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') : '';
    }
    formatDecimal(params) {
    ...
    getColDefs() {
        this.colDefs = [
            ...
            },
            {
                ...
                cellEditorParams: {
                    values: ['IDIQ - Competitive', 'BPA - Competitive',
                        'Stand Alone Contract - Competitive', 'IDIQ - Non Competitive',
                        'BPA - Non Competitive', 'Stand Alone Contract - Non Competitive',
                        'TO/DO - Competitive', 'TO/DO - Non Competitive',
                        '8(a) Contracts - Non Competitive',
                        'GSA/GWAC Services, NO SOW',
                        'GSA/GWAC for Services Requiring a SOW',
                        'Simplified Acquisition ($25001 - $250000)',
                        'Option Exercise',
                        'Bilateral Contract Modification',
                        'HHS Strategic Sourcing BPA TO/DO - Non Competitive',
                        'Basic Ordering Agreement', 'Broad Agency Announcement',
                        'Simplified Acquisition ($10001 to $25000)',
                        'Simplified Acquisition Micropurchase <=10000', 'Unilateral Modification', 'Advanced Purchase Card Purchase ($3501 - $25000)']
                },
                sortable: true,
                enableRowGroup: true,
            },
            ...
            },
            {
                ...
                cellEditorParams: {
                    values: ['New - Type 1',
                        'Supplement (Administrative Increase or Program Expansion) Type 3',
                        'Non-Competing Continuation - Type 5', 'Competing Continuation - Type 2']
                },
                sortable: true
            },
            {
            ...
            },
            {
                ...
                filter: 'agSetColumnFilter',
                editable: this.isUserAdmin(), hide: true
            },
            {
                headerName: 'Alias Name1',
    ...
    openModalWithComponent() {
        ...
        this.bsModalRef = this.modalService.show(src_app_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmDialogComponent"], { initialState });
        this.bsModalRef.content.closeBtnName = 'Close';
        this.bsModalRef.content.submitBtnName = 'Submit';
    }
};
CurrentReqReportsComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_4__["AcquisitionService"] },
...
CurrentReqReportsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-current-req-reports',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./current-req-reports.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/current-req-reports/current-req-reports.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./current-req-reports.component.scss */ "./src/app/components/current-req-reports/current-req-reports.component.scss")).default]
    })
...
let DashboardComponent = class DashboardComponent {
    constructor(layoutService) {
        ...
        this.chartData = [
            { data: [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000], label: 'Spend Plan' },
            { data: [200, 3500, 4100], label: 'Actuals' }
        ];
        ...
        this.contractchartData = [{ data: [0, 200, 400, 600, 800, 1000, 1200], label: 'contact' }];
    ...
    ngOnInit() {
        ...
        this.columnDefs = [
            ...
            { headerName: 'Requester', field: 'model' },
            { headerName: 'Request Date', field: 'price' },
    ...
    onContractChangeEvent(e) {
    }
    contractonChartClick(e) { }
};
...
ErrorPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./error-page.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/error-page/error-page.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./error-page.component.scss */ "./src/app/components/error-page/error-page.component.scss")).default]
    })
], ErrorPageComponent);
...
/* harmony import */ var src_app_shared_services_user_logged_in_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/services/user-logged-in.service */ "./src/app/shared/services/user-logged-in.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(route, router, authService, userLoggedInService, adminService) {
        this.route = route;
        this.router = router;
        this.authService = authService;
        this.userLoggedInService = userLoggedInService;
        ...
        this.errorFlag = { flag: false, message: '' };
    ...
    ngOnInit() {
        ...
        this.LoginForm.valueChanges.subscribe(p => {
            if (p !== null) {
    ...
    login() {
        if (this.LoginForm.valid) {
            console.log('valid');
            this.busy = this.authService.jwt_login(this.LoginForm.value).subscribe(args => {
                if (args) {
                    this.errorFlag.flag = false;
                    this.errorFlag.message = '';
                    console.log('login successful', args);
                    localStorage.setItem('currentUser', JSON.stringify(args));
                    this.authService.publishChanges(args);
                    this.userLoggedInService.setUserLoggedIn(true);
                    this.authService.jwt_setAccessToken(args.accesstoken);
                    this.authService.jwt_setRefreshToken(args.refreshtoken);
                    this.authService.jwt_setRole(args.rolelist);
    ...
    proceedtoLandingPage() {
        this.busy = this.adminService.getUserByEmail(this.LoginForm.value.username)
            .subscribe(data => {
            if (data) {
                this.currentUser = data;
                localStorage.setItem('UserID', this.currentUser.userId.toString());
                const loggedUserName = this.currentUser.firstName + ' ' + this.currentUser.lastName;
                localStorage.setItem('LoggedUser', loggedUserName);
                // this.shareDataService.loggedUser = loggedUserName;
                if (this.authService.jwt_hasRole('ROLE_USER')) {
                    // this.router.navigate(['app/timesheet/resplan']);
                    this.router.navigate(['/reports/current-req-report']);
                }
                else {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubmitPlanComponent", function() { return SubmitPlanComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/auth.service */ "./src/app/shared/services/auth.service.ts");
...
let SubmitPlanComponent = class SubmitPlanComponent {
    constructor(fb, authService, _acquisitionService, smartListService, modalService) {
        this.fb = fb;
        this.authService = authService;
    ...
    ngOnInit() {
        ...
        this.roleList = this.authService.jwt_getRole();
        this._acquisitionService.getAcquisitionOfficeData().subscribe(args => {
            this.officeList = args;
        });
    }
    // onGridReady(params) {
    ...
    openModalWithComponent() {
        ...
        this.bsModalRef = this.modalService.show(src_app_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmDialogComponent"], { initialState });
        this.bsModalRef.content.closeBtnName = 'Close';
        this.bsModalRef.content.submitBtnName = 'Submit';
        this.bsModalRef.content.submitEvent.subscribe(data => {
    ...
    acquisition() {
        this.busyTableSave = this._acquisitionService
            .getAcquisitionCTPDataWithOptional(this.officeCtp, this.roleList)
            .subscribe(args => {
            this.isDataPresent = true;
            if ((args != null) && (args.length > 0)) {
                ...
                this.smartListService.getSmartList(this.acquisitionList);
            }
            else {
                this.acquisitionList = [];
            }
    ...
    saveAcquisition() {
        if (this.editedData.length > 0) {
            this.smartListService.smartListToNumbers(this.editedData);
            this.busyTableSave = this._acquisitionService
                .postAcquisitionDataOptional(this.editedData, this.officeCtp)
                .subscribe(args => {
                this.editedData = [];
                this.successMessage = 'Your changes have been saved.';
                this.saveSuccess = true;
                const alloc = 'ALLOC1';
                this._acquisitionService.getAcquisitionRunCalc(alloc)
                    .subscribe(args => { this.acquisition(); });
                if (args !== null) {
                    this.successMessage = 'Your changes have been saved.';
                }
            }, e => {
    ...
    getColDefs() {
        this.colDefs = [
            ...
            },
            {
                ...
                cellEditor: 'richSelect',
                cellEditorParams: {
                    values: ['IDIQ - Competitive',
                        'BPA - Competitive',
                        'Stand Alone Contract - Competitive',
                        'IDIQ - Non Competitive', 'BPA - Non Competitive',
                        'Stand Alone Contract - Non Competitive', 'TO/DO - Competitive',
                        'TO/DO - Non Competitive', '8(a) Contracts - Non Competitive',
                        'GSA/GWAC Services, NO SOW', 'GSA/GWAC for Services Requiring a SOW',
                        'Simplified Acquisition ($25001 - $250000)',
                        'Option Exercise', 'Bilateral Contract Modification',
                        'HHS Strategic Sourcing BPA TO/DO - Non Competitive',
                        'Basic Ordering Agreement', 'Broad Agency Announcement',
...
SubmitPlanComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
    { type: _shared_services_acquisition_service__WEBPACK_IMPORTED_MODULE_4__["AcquisitionService"] },
    { type: src_app_shared_services_smartListConversion_service__WEBPACK_IMPORTED_MODULE_5__["SmartListConversionService"] },
...
SubmitPlanComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-submit-plan',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./submit-plan.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/submit-plan/submit-plan.component.html")).default
    })
], SubmitPlanComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CellHistoryDialogComponent", function() { return CellHistoryDialogComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let CellHistoryDialogComponent = class CellHistoryDialogComponent {
    constructor() { }
    ngOnInit() {
        this.columnDefs = [
            { headerName: 'User', field: 'user' },
            { headerName: 'Date', field: 'date' },
            { headerName: 'Old Value', field: 'oldValue' },
            { headerName: 'New Value', field: 'newValue' }
        ];
        this.rowData = [
            { user: 'Rohit', date: '04/21/2019', oldValue: 35000, newValue: 234456 },
            { user: 'Ford', date: '05/06/2019', oldValue: 32000, newValue: 23465 },
            { user: 'Porsche', date: '06/06/2019', oldValue: 72000, newValue: 23427 }
        ];
    }
};
CellHistoryDialogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-cell-history-dialog',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./cell-history-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/components/cell-history-dialog/cell-history-dialog.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./cell-history-dialog.component.scss */ "./src/app/shared/components/cell-history-dialog/cell-history-dialog.component.scss")).default]
    })
...
], ConfirmDialogComponent.prototype, "closeBtnName", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ConfirmDialogComponent.prototype, "submitBtnName", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ConfirmDialogComponent.prototype, "title", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ConfirmDialogComponent.prototype, "approveScreen", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ConfirmDialogComponent.prototype, "submitScreen", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CBASMultiSelectComponent", function() { return CBASMultiSelectComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CBASSelectComponent", function() { return CBASSelectComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _search_filter_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./search-filter.pipe */ "./src/app/shared/components/dropdown/search-filter.pipe.ts");
/* harmony import */ var _validation_msg_validation_msg_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../validation-msg/validation-msg.component */ "./src/app/shared/components/validation-msg/validation-msg.component.ts");
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utilities */ "./src/app/shared/utilities.ts");


// import { ExtendedComponent } from '../../Decorators/extended-component.decorator';
...
const MULTISELECT_VALUE_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => CBASMultiSelectComponent),
    multi: true
};
let nextUniqueId = 0;
let CBASMultiSelectComponent = class CBASMultiSelectComponent {
    constructor(element, fb, searchFilter, differs, ngControl, _parentForm) {
        ...
        if (this.ngControl.touched && !this.ngControl.valid && this.ngControl.errors != null) {
            ...
            for (const d in this.ngControl.errors) {
                ...
                if (valMsg != null) {
                    ...
                    this.errors.push(Object(_utilities__WEBPACK_IMPORTED_MODULE_7__["getErrorTextFromValidationResult"])(d, this.ngControl.errors[d]));
                }
            }
        }
    }
    ...
    ngOnChanges(changes) {
        if (changes['options']) {
            ...
            if (prevModel.length !== this.model.length ||
    ...
    updateTitle() {
        if (this.numSelected === 0 || this.settings.fixedTitle) {
            ...
            this.title = this.options
                .filter((option) => this.model.indexOf(option.id) > -1)
    ...
    uncheckAll() {
        if (!this.disabledSelection) {
            ...
            this.model = this.model.filter((id) => {
                if ((unCheckedOptions.indexOf(id) < 0 && this.settings.minSelectionLimit === undefined) ||
                ...
                if (this.searchFilterApplied()) {
                    if (this.checkAllSearchRegister.has(this.filterControl.value)) {
                        ...
                        this.checkAllSearchRegister.forEach(function (searchTerm) {
                            const filterOptions = this.applyFilters(this.options.filter(option => unCheckedOptions.includes(option.name)), searchTerm);
    ...
    clearSelectionButtonVisible(option) {
        return false;
    }
...
CBASMultiSelectComponent.ctorParameters = () => [
    ...
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgControl"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Self"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Optional"] }] },
...
], CBASMultiSelectComponent.prototype, "options", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "settings", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "texts", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "disabled", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "disabledSelection", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "enableSearch", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "placeholder", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "label", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "isRequired", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "selectionLimitReached", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "dropdownClosed", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "dropdownOpened", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "onAdded", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "onRemoved", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "onLazyLoad", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"])()
], CBASMultiSelectComponent.prototype, "onFilter", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "removeOptional", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"])()
], CBASMultiSelectComponent.prototype, "id", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ContentChildren"])(_validation_msg_validation_msg_component__WEBPACK_IMPORTED_MODULE_6__["ValidationMsg"], { descendants: true })
...
], CBASMultiSelectComponent.prototype, "onClick", null);
CBASMultiSelectComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Self"])()),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Optional"])()),
...
const SELECT_VALUE_ACCESSOR = {
    provide: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NG_VALUE_ACCESSOR"],
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => CBASSelectComponent),
    multi: true
};
let CBASSelectComponent = class CBASSelectComponent extends CBASMultiSelectComponent {
    /**
     *
     */
    constructor(element, fb, searchFilter, differs, ngControl, _parentForm) {
    ...
    keyDownFunction(event, option) {
        if (event.keyCode === 13) {
            this.setSelected(event, option);
        }
    }
};
CBASSelectComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ElementRef"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
    { type: _search_filter_pipe__WEBPACK_IMPORTED_MODULE_5__["MultiSelectSearchFilter"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["IterableDiffers"] },
...
CBASSelectComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-select',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./dropdown.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/components/dropdown/dropdown.component.html")).default,
...
let MultiSelectSearchFilter = class MultiSelectSearchFilter {
    ...
    transform(options, str, limit = 0, renderLimit = 0) {
        ...
        const matchPredicate = (option) => regexp.test(option.name), getChildren = (option) => options.filter(child => child.parentId === option.id), getParent = (option) => options.find(parent => option.parentId === parent.id);
        let i = 0, founded = 0;
...
MultiSelectSearchFilter = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewHeaderComponent", function() { return NewHeaderComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _new_header_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./new-header.enum */ "./src/app/shared/components/new-header/new-header.enum.ts");
...
let NewHeaderComponent = class NewHeaderComponent {
    constructor(authService) {
        this.authService = authService;
    }
    ngOnInit() {
...
NewHeaderComponent.ctorParameters = () => [
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }
];
NewHeaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-new-header',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-header.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/components/new-header/new-header.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-header.component.scss */ "./src/app/shared/components/new-header/new-header.component.scss")).default]
    })
], NewHeaderComponent);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HeaderMenuItems", function() { return HeaderMenuItems; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _sidebar_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sidebar.enum */ "./src/app/shared/components/sidebar/sidebar.enum.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SidebarItems", function() { return SidebarItems; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TEXT_INPUT_CONTROL_VALUE_ACCESSOR", function() { return TEXT_INPUT_CONTROL_VALUE_ACCESSOR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextInputComponent", function() { return TextInputComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _validation_msg_validation_msg_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../validation-msg/validation-msg.component */ "./src/app/shared/components/validation-msg/validation-msg.component.ts");
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utilities */ "./src/app/shared/utilities.ts");
...
// import { NgbTooltip } from '@ng-bootstrap';
const TEXT_INPUT_CONTROL_VALUE_ACCESSOR = {
    provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => TextInputComponent),
    multi: true
};
let nextUniqueId = 0;
let nextAriaDescribedById = 0;
let TextInputComponent = class TextInputComponent {
    constructor(_parentForm, ngControl, tabIndex) {
        this._parentForm = _parentForm;
        this.ngControl = ngControl;
        this._uid = `app-input-${nextUniqueId++}`;
        this._ariadesribedById = `ai-aria-text-input-${nextAriaDescribedById++}`;
        this.type = 'text';
        this.disabled = false;
        ...
        if (this.ngControl.touched &&
            ...
            for (const d in this.ngControl.errors) {
                ...
                if (valMsg != null) {
                    ...
                    this.errors.push(Object(_utilities__WEBPACK_IMPORTED_MODULE_4__["getErrorTextFromValidationResult"])(d, this.ngControl.errors[d]));
                }
            }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('focusElement', { static: false })
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "focusOnValidate", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "mask", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "formatHelp", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "text", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "tabIndex", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "maxLength", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "autocomplete", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "id", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "focusOnLoad", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ContentChildren"])(_validation_msg_validation_msg_component__WEBPACK_IMPORTED_MODULE_3__["ValidationMsg"], { descendants: true })
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "showRemainingCharacters", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TextInputComponent.prototype, "removeOptional", void 0);
TextInputComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Attribute"])('tabindex'))
], TextInputComponent);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ValidationMsg.prototype, "validator", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ValidationMsg.prototype, "msg", void 0);
ValidationMsg = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
const components = {};
let LayoutItemDirective = class LayoutItemDirective {
    constructor(container, resolver) {
...
LayoutItemDirective.ctorParameters = () => [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AcquisitionService", function() { return AcquisitionService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var src_app_app_api_endpoints_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/app-api-endpoints.config */ "./src/app/app-api-endpoints.config.ts");
...
let AcquisitionService = class AcquisitionService {
    ...
    postAcquisitionData(payload, office1, acquisitionType1, version1) {
        const url = this.getAcquisitionurl + `updatewithctp/?office=${office1}&acquisitonType=${acquisitionType1}&version=${version1}`;
        return this.http.post(url, payload, httpOptions);
    }
    getAcquisitionGridFilter(userId) {
        return this.http.get(this.getReportStateUrl + 'filter/list/?userid=' + userId, httpOptions);
    }
    postAcquisitionGridFilter(payload) {
        return this.http.post(this.getReportStateUrl + 'savefilter/', payload, httpOptions);
    }
    postAcquisitionDataOptional(payload, office1) {
        return this.http.post(this.getAcquisitionurl + 'updatewithctp/?office=' + office1, payload, httpOptions);
    }
    getAcquisitionOfficeData() {
        return this.http.get(this.getAcquisitionOfficeurl, httpOptions);
    }
    getAcquisitionPreCommitmentData() {
        return this.http.get(this.getAcquistionPrecommitmenturl, httpOptions);
    }
    getAcquisitionPreCommitmentDataWithOffice(office) {
        return this.http.get(this.getAcquistionPrecommitmenturl + '?office=' + office, httpOptions);
    }
    getAcquisitionPreCommitmentDataWithAcquisition(office, acquisitonType) {
        const url = this.getAcquistionPrecommitmenturl + '?office=' + office + '&acquisitonType=' + acquisitonType;
        return this.http.get(url, httpOptions);
    }
    getAcquisitionFYTwentyData(office, acquisitionType, version, lineItem) {
        const url = this.getAcquisitionfy20 + `?office=${office}&acquisitonType=${acquisitionType}&version=${version}&lineItem=${lineItem}`;
        return this.http.get(url, httpOptions);
    }
    getAcquisitionCTPData(office1, acquisitionType1, version1, role) {
        const url = this.getAcquisitionurl + `ctp/?office=${office1}&acquisitonType=${acquisitionType1}&version=${version1}&role=${role}`;
        return this.http.get(url, httpOptions);
    }
    getAcquisitionCTPDataWithOptional(office1, role) {
        return this.http.get(this.getAcquisitionurl + 'ctp/?office=' + office1 + '&role=' + role, httpOptions);
    }
    getAcquisitionRunCalc(ALLOC1) {
        return this.http.get(this.getAcquisitionurl + 'runcalc/?runcCalcValue=ALLOC1', httpOptions);
    }
    getAcquisitionRunCalcRevisdAmt() {
        return this.http.get(this.getAcquisitionurl + 'runcalc/?runcCalcValue=AGGSPC', httpOptions);
    }
};
AcquisitionService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: src_app_app_api_endpoints_config__WEBPACK_IMPORTED_MODULE_3__["ApiEndpointsConfig"] }
];
AcquisitionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], AcquisitionService);
...
/* harmony import */ var src_app_app_api_endpoints_config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/app-api-endpoints.config */ "./src/app/app-api-endpoints.config.ts");
...
let AuthService = class AuthService {
    constructor(http, router, appEndPoints) {
        this.http = http;
        this.router = router;
        this.appEndPoints = appEndPoints;
...
let LayoutService = class LayoutService {
    ...
    dropItem(dragId) {
        ...
        const updateIdx = comp ? components.indexOf(comp) : components.length;
        const componentItem = {
            id: this.dropId,
            componentRef: dragId
        };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoggedInUserGuard", function() { return LoggedInUserGuard; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let LoggedInUserGuard = class LoggedInUserGuard {
...
LoggedInUserGuard.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }
];
LoggedInUserGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], LoggedInUserGuard);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SmartListConversionService", function() { return SmartListConversionService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let SmartListConversionService = class SmartListConversionService {
    constructor() { }
    getSmartList(acquisitionData) {
...
SmartListConversionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], SmartListConversionService);
...
let UserLoggedInService = class UserLoggedInService {
    constructor() {
...
UserLoggedInService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], UserLoggedInService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasRequiredValidator", function() { return hasRequiredValidator; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasRequiredField", function() { return hasRequiredField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "triggerValidations", function() { return triggerValidations; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "upperCaseFirstChar", function() { return upperCaseFirstChar; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getErrorTextFromValidationResult", function() { return getErrorTextFromValidationResult; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
const hasRequiredValidator = (abstractControl) => {
...
const triggerValidations = function (formGroup, onlySelf = false) {
    if (onlySelf) {
...
const getErrorTextFromValidationResult = function (errorKey, error) {
...
module.exports = __webpack_require__(/*! C:\Users\asapa\GitHub\TestUIInstance\cbas-app\src\main.ts */"./src/main.ts");
