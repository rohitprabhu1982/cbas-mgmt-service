...
@Component("twoFactAuthFailureHandler")
public class TwoFactorAuthenticationFailureHandler implements AuthenticationFailureHandler {

    @Autowired
    private ObjectMapper objectMapper;

    @Autowired
    public TwoFactorAuthenticationFailureHandler(ObjectMapper mapper) {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
        ...
        if (e instanceof BadCredentialsException) {
            objectMapper.writeValue(response.getWriter(), ErrorResponse.of("Invalid verification code", ErrorCode.AUTHENTICATION, HttpStatus.UNAUTHORIZED));
